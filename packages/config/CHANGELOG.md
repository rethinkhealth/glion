...
- [#772](https://github.com/rethinkhealth/glion/pull/772) [`8f37d7e`](https://github.com/rethinkhealth/glion/commit/8f37d7e93b31ef48158f6e19ff7842fb9adb0e1f) Thanks [@meleksomai](https://github.com/meleksomai)! - Update `cosmiconfig` to 10.0.1, which clears the four `js-yaml` advisories (GHSA-42h9-826w-cgv3 and related) reachable through `loadConfig()` and `loadConfigSync()` when a `.hl7v2rc.yaml` file is read.
