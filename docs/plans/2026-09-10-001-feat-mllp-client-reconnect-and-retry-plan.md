...
- Phase graph (`src/state.ts`): `idle → connecting → connected ⇄ sending → closing → closed`, and every wire failure → `closed`. `#connection` is documented as "the one connection this client ever makes".
...
- Events (`src/events.ts`): `connect`, `disconnect(error | null)`, `close`. The issue says `reconnecting(attempt, delayMs)` is declared and never emitted; in the shipped #692 it is not declared at all. This work adds it.
...
- 16 tests in `test/client.test.ts` assert `state === "closed"` after a failure.
...
| Where                 | What                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `src/state.ts`        | The `reconnecting` phase.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `src/events.ts`       | `reconnecting(attempt: number, delayMs: number): void`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
- D1 on by default. D2 the policy covers the first connection too (recommendation overruled). D3 `reconnect`, with `delay(attempt, error)`. D4 bounded: 5 attempts, backoff 200 ms → 2 s. D5 waiters wait; `CLOSED` carries `cause`. D6 ADR 0021; ADR 0020 withdrawn.
